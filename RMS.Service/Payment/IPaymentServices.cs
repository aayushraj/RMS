...
namespace RMS.Service.Payment
{
    ...
    public class PaymentServices : IPaymentServices
    {
        ...
        public PaymentServices(IRentSetupService rentSer,IPaymentRepository paymentRepo)
        {
        ...
        public PaymentModel CalculateDueAndAdvance(RentSetupModel rentSetUpModel, PaymentModel model, bool CheckPayment)
        {
            ...
            else
            {
                ...
                _paymentRepo.Edit(model.TenantId);
        ...
        {
            bool flag = false;
            var rentSetupModel = _rentSer.GetByFloorId(model.FloorId);
            var dueModel = _paymentRepo.Getdue(model.TenantId);
            var advanceModel = _paymentRepo.GetAdvance(model.TenantId);
            ...
            var Created = _paymentRepo.Create(model);
